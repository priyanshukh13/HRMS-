...
const Sidebar = () => {
    ...
    return (
        <div className="w-64 h-screen bg-gradient-to-b from-sky-200 to-sky-300 flex flex-col shadow-lg">
            {/* Header Section */}
            ...
            <div className="p-6 flex items-center space-x-3 border-b border-sky-300">
                <div className="w-16 h-16 rounded-full bg-gray-300 overflow-hidden flex-shrink-0 border-4 border-white shadow-md">
                    <img
